const translations = {
  en: {
    ...
    "hero.body":
      "RuleMeter is a report-only review aid for same-file duplicate instructions, cross-file verbatim overlaps, and optional near-duplicate review prompts.",
  ...
  ko: {
    ...
    "hero.body":
      "RuleMeter는 같은 파일 내부 중복 지시문, 파일 간 축자 overlap, 선택형 유사 규칙 후보를 보여주는 report-only review aid입니다.",
  ...
  ja: {
    ...
    "hero.body":
      "RuleMeter は、同一ファイル内の重複指示、ファイル間の逐語 overlap、任意の類似規則候補を示す report-only review aid です。",
